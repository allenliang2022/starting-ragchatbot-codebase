...
"""
            ...
            if response.choices[0].finish_reason == "tool_calls" and tool_manager:
                ...
                if not should_continue:
                    ...
                    return (
                        final_response
                        if final_response
                        else self._get_final_response(messages)
                    )
    ...
    def _get_final_response(self, messages: List[Dict]) -> str:
        ...
        final_params = {**self.base_params, "messages": continuation_messages}
    ...
    def _should_continue_to_next_round(
        ...
        decision_params = {**self.base_params, "messages": decision_messages}
